...
export function CornerCross({ position }: { position: "top-left" | "top-right" | "bottom-left" | "bottom-right" }) {
  ...
  return (
    <div className={cn("absolute z-[2]", posClasses[position])}>
...
export function DottedPattern() {
  return (
    <div className="screen-line-before screen-line-after border-x border-edge select-none">
      <div className="overflow-hidden px-2 py-5 sm:px-4">
        <div
          className="h-full min-h-[70px] w-full bg-center sm:min-h-[110px]"
          style={{
